...
class __TwigTemplate_a976c065e10282270c35c8d650a06594ff58905cbb582234496693ebe9335ffd extends Twig_Template
{
    ...
    public function block_choice_widget_options($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["group_label"] => $context["choice"]) {
            ...
            if (twig_test_iterable($context["choice"])) {
                // line 91
                echo "            <optgroup label=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans($context["group_label"]), "html", null, true);
                echo "\">
                ";
                // line 92
    ...
    public function block_widget_attributes($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["attrname"] => $context["attrvalue"]) {
            if (twig_in_filter($context["attrname"], array(0 => "placeholder", 1 => "title"))) {
                echo twig_escape_filter($this->env, $context["attrname"], "html", null, true);
                echo "=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans($context["attrvalue"]), "html", null, true);
                echo "\" ";
            } else {
                echo twig_escape_filter($this->env, $context["attrname"], "html", null, true);
                echo "=\"";
...
/*             <option {% if required %} disabled="disabled"{% if value is empty %} selected="selected"{% endif %}{% else %} value=""{% endif %}>{{ empty_value|trans }}</option>*/
/*         {% endif %}*/
